...
COMMENT ON COLUMN customer.cust_level IS
    'customer level(either Gold, Silver, Bronze)';
...
COMMENT ON COLUMN orderline.ol_qtyordered IS
    'quantity ordered for each product in an order';

COMMENT ON COLUMN orderline.ol_lineprice IS
    'total price for each product in an order';
...
CREATE TABLE prod_category (
    pcat_id    NUMBER(3) NOT NULL,
    pcat_name  VARCHAR2(30) NOT NULL
);
