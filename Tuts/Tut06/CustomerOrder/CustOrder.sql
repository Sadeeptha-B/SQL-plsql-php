...
ALTER TABLE customer ADD CONSTRAINT un_custphone UNIQUE ( cust_phone );
...
ALTER TABLE orders
    ADD CONSTRAINT relation_5 FOREIGN KEY ( cust_no )
        REFERENCES customer ( cust_no );

ALTER TABLE product
    ADD CONSTRAINT relation_8 FOREIGN KEY ( pcat_id )
